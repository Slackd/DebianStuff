...
# Backupp
alias Backup-local='sudo /home/sam/Scripts/laptop_backup_local.sh'

# SSH
alias Libertas='ssh sam@192.168.1.3'
alias Libertas-X='ssh -X sam@192.168.1.3'
alias L-get='echo "/path/to/host/file ~/path/to/destination" && scp sam@192.168.1.3:'

## Stress test
alias Stress='systester-cli -gausslg 64M -threads 4'

## DEs
alias Cinnamon='sudo /home/sam/Scripts/cinnamon.sh'
alias Awesome='sudo /home/sam/Scripts/awesome.sh'
...
## Theming
alias 1080='/home/sam/Scripts/Theming/1080.sh'
alias 1440='/home/sam/Scripts/Theming/1440.sh'
...
alias top100='/home/sam/Scripts/top100.sh'
alias time_international='/home/sam/Scripts/time_international.sh'
alias natgeo='/home/sam/Scripts/natgeo.sh'
alias ballz='python /home/sam/Scripts/Games/Ballz.py'
...
alias net-urlsnarf='echo "see which websites others on network are visiting" && sudo urlsnarf -i wlp6s0 |cut -d\" -f4'
...
plugins=(git git-extras archlinux vi-mode themes zsh-completions color-command tmux vundle vim-interaction systemd sudo web-search ruby python profiles nmap history history-substring-search gnu-utils command-not-found common-aliases colored-man colorize gem)
#source /usr/share/zsh/plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
source /home/sam/.oh-my-zsh/oh-my-zsh.sh


clear
/home/sam/Scripts/spaceinv.sh
#linux_logo -L 2
