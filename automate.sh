...
apt-get install gvfs-backends gvfs-fuse clearlooks-phenix-theme gtk2-engines-murrine gtk2-engines-pixbuf gtk3-engines-xfce gtk3-engines-unity mesa-utils mesa-utils-extra light-locker -y
